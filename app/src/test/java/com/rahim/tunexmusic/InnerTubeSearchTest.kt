    ...
    fun testYouTubeMusicSearchFacade() {
        runBlocking {
            ...
            parsedResult.onSuccess { searchResult ->
                ...
                val songCount = searchResult.items.count { it is com.rahim.tunexmusic.data.innertube.SearchItem.Song }
                val artistCount = searchResult.items.count { it is com.rahim.tunexmusic.data.innertube.SearchItem.Artist }
                val playlistCount = searchResult.items.count { it is com.rahim.tunexmusic.data.innertube.SearchItem.Playlist }
