package com.rahim.tunexmusic.update;
...
public class UpdateManager {
    ...
    private static final String GITHUB_OWNER = "ahamed-2";
    private static final String GITHUB_REPO = "TuneX-Music";
    ...
    private void startDownload(View rootView, String apkUrl) {
        try {
            ...
            request.setTitle("TuneX Music Update");
            request.setDescription("Downloading latest version...");
            request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);

            String filename = "TuneXMusic-update.apk";
    ...
    private void showSnackbarAnchored(View rootView, String msg, int duration) {
        runOnUi(() -> com.rahim.tunexmusic.ui.SnackbarController.INSTANCE.showMessage(msg));
    }
