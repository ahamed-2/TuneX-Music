package com.rahim.tunexmusic.data.lyrics.engine

import android.content.Context
import android.os.Handler
import android.os.Looper
import android.util.Log
import com.rahim.tunexmusic.data.lyrics.ConfidenceScorer
import com.rahim.tunexmusic.data.lyrics.LrcLibApi
import com.rahim.tunexmusic.data.lyrics.LyricsNormalizer
import com.rahim.tunexmusic.data.lyrics.LyricsResult
import com.rahim.tunexmusic.data.lyrics.MetadataRepair
import com.rahim.tunexmusic.data.lyrics.TrackMetadata
import com.rahim.tunexmusic.data.lyrics.providers.EmbeddedLyricsProvider
import com.rahim.tunexmusic.data.lyrics.providers.LrcLibProvider
import com.rahim.tunexmusic.data.lyrics.providers.LyricsProvider
...
class LyricsFetchManager private constructor(context: Context) {
    ...
    private fun createProviders(client: OkHttpClient): List<LyricsProvider> {
        ...
        // ═══════════════════════════════════════════
        providers.add(com.rahim.tunexmusic.data.lyrics.providers.YouTubeMusicLyricsProvider())
        ...
        val syncLrcApi = Retrofit.Builder()
            ...
            .addConverterFactory(GsonConverterFactory.create())
            .build()
            .create(com.rahim.tunexmusic.data.lyrics.SyncLrcApi::class.java)
        providers.add(com.rahim.tunexmusic.data.lyrics.providers.SyncLrcProvider(syncLrcApi))
        ...
        val paxsenixApi = Retrofit.Builder()
            ...
            .addConverterFactory(GsonConverterFactory.create())
            .build()
            .create(com.rahim.tunexmusic.data.lyrics.PaxsenixApi::class.java)

        providers.add(com.rahim.tunexmusic.data.lyrics.providers.paxsenix.PaxsenixAppleMusicProvider(paxsenixApi))
        providers.add(com.rahim.tunexmusic.data.lyrics.providers.paxsenix.PaxsenixSpotifyProvider(paxsenixApi))
        providers.add(com.rahim.tunexmusic.data.lyrics.providers.paxsenix.PaxsenixMusixmatchProvider(paxsenixApi))
        providers.add(com.rahim.tunexmusic.data.lyrics.providers.paxsenix.PaxsenixYoutubeProvider(paxsenixApi))
