package com.rahim.tunexmusic.model
...
fun SongItem.toPlaylistSongEntity(playlistId: Long, position: Int = 0): com.rahim.tunexmusic.data.db.PlaylistSongEntity {
    return com.rahim.tunexmusic.data.db.PlaylistSongEntity(
...
fun com.rahim.tunexmusic.data.db.PlaylistSongEntity.toSongItem(): SongItem {
