...
import com.rahim.tunexmusic.service.AudioPlaybackService
import com.rahim.tunexmusic.ui.EffectsScreenEntryPoint
import com.rahim.tunexmusic.ui.PlayerBottomSheetCompose
import com.rahim.tunexmusic.ui.SettingsScreenContent
import com.rahim.tunexmusic.ui.TagEditorScreenEntryPoint
import com.rahim.tunexmusic.ui.explore.ExploreScreen
import com.rahim.tunexmusic.ui.explore.GoogleSignInScreen
import com.rahim.tunexmusic.ui.library.LibraryScreen
import com.rahim.tunexmusic.ui.theme.TuneXMusicTheme
import com.rahim.tunexmusic.ui.theme.observeKey
import com.rahim.tunexmusic.ui.onboarding.OnboardingScreen
import android.content.Context
import com.rahim.tunexmusic.update.GitHubReleaseClient
import com.rahim.tunexmusic.update.UpdateManager
import com.rahim.tunexmusic.update.VersionUtils
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            TuneXMusicTheme(darkTheme = isDarkTheme, dynamicAlbumColor = dynamicAlbumColor) {
                        ...
                        Box(
                            ...
                            NavHost(
                                ...
                                composable("google_signin") {
                                    val accountViewModel: com.rahim.tunexmusic.viewmodel.AccountViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
                                    GoogleSignInScreen(
    ...
    fun showArtistPage(artistId: String?, artistName: String?) {
        ...
        if (!artistId.isNullOrBlank()) {
            ...
            exploreViewModel.setSearchFilter(com.rahim.tunexmusic.data.innertube.SearchFilter.ARTISTS)
    ...
    private fun checkForUpdateOnLaunch() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                val client = GitHubReleaseClient("ahamed-2", "TuneX-Music")
    ...
    fun showSnackbar(message: String, duration: Int) {
        com.rahim.tunexmusic.ui.SnackbarController.showMessage(message)
    }
