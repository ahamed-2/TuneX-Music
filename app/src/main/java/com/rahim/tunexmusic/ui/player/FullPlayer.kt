package com.rahim.tunexmusic.ui.player
...
import com.rahim.tunexmusic.data.lyrics.LyricLine
...
fun FullPlayerScreen(
    ...
    val permissionLauncher = rememberLauncherForActivityResult(
        ...
        if (isGranted) {
            ...
            com.rahim.tunexmusic.ui.SnackbarController.showMessage("Microphone permission required for haptics")
        }
    }
                ...
                PillChip(
                    ...
                    onClick = {
                        val shareIntent = Intent().apply {
                            ...
                            putExtra(Intent.EXTRA_TEXT, "Listening on TuneX Music Check out : https://music.youtube.com/watch?v=${uiState.currentSong?.videoId}")
                            type = "text/plain"
                        }
                ...
                PillChip(
                    ...
                    onClick = {
                        ...
                        if (currentSong != null && !realDownloaded && !isDownloading) {
                            com.rahim.tunexmusic.util.SongDownloader.downloadSong(context, currentSong)
                        }
                    },
                    contentColor = contentColor,
                    accentColor = dynamicAccentColor,
