package com.rahim.tunexmusic.ui.widget;
...
/**
 * Base Widget Provider for TuneXMusic.
 * Handles common playback control intents and updates all 3 widget sizes.
 */
public class TuneXMusicWidgetProvider extends AppWidgetProvider {

    private static final String TAG = "TuneXMusicWidget";

    // Intent Actions from AudioPlaybackService (must match exactly)
    private static final String ACTION_PLAY = "com.rahim.tunexmusic.ACTION_PLAY";
    private static final String ACTION_PAUSE = "com.rahim.tunexmusic.ACTION_PAUSE";
    private static final String ACTION_PREVIOUS = "com.rahim.tunexmusic.ACTION_PREVIOUS";
    private static final String ACTION_NEXT = "com.rahim.tunexmusic.ACTION_NEXT";
    private static final String ACTION_TOGGLE_LYRICS = "com.rahim.tunexmusic.ACTION_TOGGLE_LYRICS";

    private static final String PREFS_NAME = "tunexmusic_widget_prefs";
    ...
    private static void updateWidget(Context context, AppWidgetManager manager, int id, SongItem song,
        ...
        try {
            ...
            if (song != null) {
                ...
                if (layoutId == R.layout.widget_medium || layoutId == R.layout.widget_large) {
                    views.setTextViewText(R.id.widget_song_title, "TuneXMusic");
    ...
    public static String findCurrentLyricLine(java.util.List<com.rahim.tunexmusic.data.lyrics.LyricLine> lyrics,
            int position) {
        if (lyrics == null || lyrics.isEmpty())
            return null;

        String currentLine = lyrics.get(0).content;
        for (com.rahim.tunexmusic.data.lyrics.LyricLine line : lyrics) {
    ...
    private static void setupPendingIntents(Context context, RemoteViews views, boolean isPlaying, int layoutId, Class<?> providerClass) {
        ...
        Intent launchIntent = new Intent(context, com.rahim.tunexmusic.MainActivity.class);
        ...
        if (layoutId == R.layout.widget_large) {
            ...
            PendingIntent piFav = getServicePendingIntent(context, "com.rahim.tunexmusic.ACTION_TOGGLE_FAV", 13);
            views.setOnClickPendingIntent(R.id.widget_favorite, piFav);

            // Repeat/Loop Button Intent
            PendingIntent piLoop = getServicePendingIntent(context, "com.rahim.tunexmusic.ACTION_TOGGLE_LOOP", 14);
    ...
    private static PendingIntent getServicePendingIntent(Context context, String action, int requestCode) {
        Intent intent = new Intent(context, com.rahim.tunexmusic.service.AudioPlaybackService.class);
